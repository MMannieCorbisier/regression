...
def run_fint_second_order_consistency_test(
    ...
    gmad_name_zero = base_name_zero + ".gmad"
    root_name_zero = base_name_zero + ".root"
    optics_name_zero = base_name_zero + "_optics.root"

    base_name_fint = base_name + "_fint"
    gmad_name_fint = base_name_fint + ".gmad"
    root_name_fint= base_name_fint + ".root"
    optics_name_fint = base_name_fint + "_optics.root"
...
def run_h1_second_order_difference_test(template_name, base_name, data, h1=0.0, h2=0.0):
    ...
    gmad_name_nonzero = base_name_nonzero + ".gmad"
    root_name_nonzero = base_name_nonzero + ".root"
    optics_name_nonzero = base_name_nonzero + "_optics.root"
...
def run_second_order_tilt_consistency_test(template_name, base_name, data):
    ...
    gmad_name_untilted = base_name_untilted + ".gmad"
    root_name_untilted = base_name_untilted + ".root"
    optics_name_untilted = base_name_untilted + "_optics.root"

    base_name_tilted = base_name + "_tilted"
    gmad_name_tilted = base_name_tilted + ".gmad"
    root_name_tilted = base_name_tilted + ".root"
    optics_name_tilted = base_name_tilted + "_optics.root"
...
def run_first_order_test(template_name, base_name, data):
    ...
    pybdsim.Run.RenderGmadJinjaTemplate(template_name, gmad_name, data1)
    pybdsim.Run.Bdsim(gmad_name, base_name, 3000, 1, silent=True)
    pybdsim.Run.RebdsimOptics(root_name, optics_name, silent=True)
